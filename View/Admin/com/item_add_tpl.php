...
<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
        	<li><a href="index.html?com=com&act=add<?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>"><span>Thêm com</span></a></li>
...
<form name="frm"  class="form"  method="post" action="index.html?com=com&act=save" enctype="multipart/form-data" class="nhaplieu">
<div class="widget">
	<div class="formRow">
		<label>Tên :</label>
		<div class="formRight">
	...
	<div class="formRight">
		...
		<input type="button" value="Thoát" onclick="javascript:window.location='index.html?com=com&act=man'" class="button blueB" />
	</div>
	<div class="clear"></div>
	</div>
</div>
