...
<div class="control_frm">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
        	<li><a href="admin/cate/add_item/<?=$_GET['type']?>"><span>Thêm <?=$type->title?></span></a></li>
...
<form name="supplier" id="validate" class="form" action="admin/cate/save_item/<?=$_GET['type']?>" method="post" enctype="multipart/form-data">
	<div class="widget">
		...
		<div class="formRow">
			...
			<div class="formRight">
			<div class="mt10"><img src="<?=_upload_cate_l.$this->model->data['thumb']?>"  alt="NO PHOTO" width="100" /></div>
			</div>
			<div class="clear"></div>
		</div>
		<?php } } ?>
	...
	<div class="widget">
		...
		<div class="formRow">
			<div class="formRight">
            	...
            	<a href="admin/cate/man_item/<?=$_GET['type']?>" onClick="if(!confirm('Bạn có muốn thoát không ? ')) return false;" title="" class="button tipS" original-title="Thoát">Thoát</a>
			</div>
			<div class="clear"></div>
		</div>
