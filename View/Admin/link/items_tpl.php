...
<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
        	<li><a href="admin/link/man/<?=$_GET['type']?>"><span>Quản lý <?=$type->title ?></span></a></li>
        	<?php if($_GET['keyword']!=''){ ?>
...
<div class="control_frm" style="margin-top:0;">
  	<div style="float:left;">
    	  <input type="button" class="blueB" value="Thêm" onclick="location.href='admin/link/add/<?=$_GET['type']?>'" />
...
<div class="widget">
  ...
  <table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable SearchTable" id="checkAll">
    ...
    <tbody>
        ...
        <?php if(in_array('image',$type->config_open)){ ?>
          <td align="center"><img src="<?=_upload_hinhanh_l.$value['thumb']?>" /></td>
        <?php } ?>
        
        <td class="title_name_data">
            <a href="admin/link/edit?id=<?=$value['id']?><?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" class="tipS SC_bold"><?=$value['name_vi']?></a>
        </td>
        ...
        <td class="actBtns">
            <a href="admin/link/edit/<?=$_GET['type']?>?id=<?=$value['id']?><?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" title="" class="smallButton tipS" original-title="Sửa bài viết"><img src="assets/admin/images/icons/dark/pencil.png" alt=""></a>
            <a href="admin/link/delete/<?=$_GET['type']?>?listid=<?=$value['id']?><?php if($_REQUEST['type']!='') echo'&type='. $_REQUEST['type'];?>" onClick="if(!confirm('Xác nhận xóa')) return false;" title="" class="smallButton tipS" original-title="Xóa bài viết"><img src="assets/admin/images/icons/dark/close.png" alt=""></a>
        </td>
      </tr>
         <?php } ?>
                </tbody>
