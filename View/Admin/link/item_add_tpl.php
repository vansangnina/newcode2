...
<div class="control_frm">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
        	<li><a href="admin/link/add/<?=$_GET['type']?>>"><span>Thêm <?=$type->title?></span></a></li>
...
<form name="supplier" id="validate" class="form" action="admin/link/save/<?=$_GET['type']?>" method="post" enctype="multipart/form-data">
	<div class="widget">
		...
		<div class="formRow">
			...
			<div class="mt10"><img src="<?=_upload_hinhanh_l.$this->model->data['thumb']?>"  alt="NO PHOTO" width="<?=_width_thumb?>" /></div>
		...
		<div class="formRow">
			<label>Link  </label>
			<div class="formRight">
                <input type="text" name="link" title="Nhập link" id="link" class="tipS validate[required]" value="<?=@$this->model->data['link']?>" />
			</div>
			<div class="clear"></div>
		</div>
		<?php } ?>
	...
	<div class="widget">
		<div class="formRow">
			<div class="formRight">
            	...
            	<a href="admin/link/man/<?=$_GET['type']?>" onClick="if(!confirm('Bạn có muốn thoát không ? ')) return false;" title="" class="button tipS" original-title="Thoát">Thoát</a>
			</div>
			<div class="clear"></div>
		</div>
