...
<div class="control_frm">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
        	<li><a href="admin/post/add_list/<?=$_GET['type']?>"><span>Thêm <?=$type->title?></span></a></li>
...
<form name="supplier" id="validate" class="form" action="admin/post/save/<?=$_GET['type']?>" method="post" enctype="multipart/form-data">
	<div class="widget">
		...
		<div class="formRow">
			...
			<div class="mt10"><img src="<?=_upload_post_l.$this->model->data['thumb']?>"  alt="NO PHOTO" width="100" /></div>
		...
		<div class="formRow">
			...
			<div class="formRight">
			<?php 
				$size = explode(',',$this->model->data['size']);
		...
		<div class="formRow">
			...
			<div class="formRight">
			<?php 
				$mausac = explode(',',$this->model->data['mausac']);
	...
	<div class="widget">
		...
		<div class="formRow">
			<div class="formRight">
            	...
            	<a href="admin/post/man/<?=$_GET['type']?>" onClick="if(!confirm('Bạn có muốn thoát không ? ')) return false;" title="" class="button tipS" original-title="Thoát">Thoát</a>
			</div>
			<div class="clear"></div>
		</div>
