...
$(document).ready(function(e) {	
	...
	$('span.tag_on_ar a').click(function(){		
		...
		jQuery.ajax({
			type: 'POST',
			url: baseurl + 'Ajax/AdminAjax.php?do=articles&act=tags',
			data: {
				'uni_tag':uni_tag, 
				'id':get_id
			},
	...
	$('span#tag_on_products a').click(function(){		
		...
		jQuery.ajax({
			type: 'POST',
			url: baseurl + 'Ajax/AdminAjax.php?do=products&act=tags',
			data: {
				'uni_tag':uni_tag, 
				'id':get_id
			},
...
function updateNumber(table, id)
{
	...
	jQuery.ajax({
		type: 'POST',
		url: baseurl + 'Ajax/AdminAjax.php?do=number&act=update',
...
$(document).ready(function(e) {
	...
	jQuery('.logMeIn').click(function() {
		...
		if (email && pass)
		{
			...
			jQuery.ajax({
				type: 'POST',
				url: baseurl + 'Ajax/AdminAjax.php?do=admin&act=login',
	...
	jQuery('#userLogout').click(function() {
		jQuery.ajax({
			type: 'POST',
			url: baseurl + 'Ajax/AdminAjax.php?do=admin&act=logout',
			success: function(data) {
	...
	jQuery('.sendEmail').click(function() {
		...
		if (email)
		{
			...
			jQuery.ajax({
				type: 'POST',
				url: baseurl + 'Ajax/AdminAjax.php?do=admin&act=forgotpass',
				data: {'email':email},
				success: function(data) {
					$('.ajaxloader').css('display', 'none');
					var myObject = eval('(' + data + ')');
	...
	jQuery('#addField').click(function() {
		...
		if (name_vn && value_vn)
		{
			...
			jQuery.ajax({
				type: 'POST',
				url: baseurl + 'Ajax/AdminAjax.php?do=customfield&act=add',
	...
	jQuery('#addModule').click(function() {
		...
		if (name)
		{
			jQuery.ajax({
				type: 'POST',
				url: baseurl + 'Ajax/AdminAjax.php?do=salepage&act=add',
...
function updateField(id)
{
	...
	if (name_vn && value_vn)
	{
		...
		jQuery.ajax({
			type:'POST',
			url:baseurl + 'Ajax/AdminAjax.php?do=customfield&act=update',
...
function deleteField(id, proid)
{
	...
	jQuery.ajax({
		type:'POST',
		url:baseurl + 'Ajax/AdminAjax.php?do=customfield&act=delete',
...
function fillValue(name)
{
	...
	jQuery.ajax({
		type:'POST',
		url:baseurl + 'Ajax/AdminAjax.php?do=customfield&act=fill',
		data: {'name':name},
		success:function (data) {
			$('.ajaxloader').css('display', 'none');
			var myObject = eval('(' + data + ')');
...
function deleteModule(id)
{
	jQuery.ajax({
		type:'POST',
		url:baseurl + 'Ajax/AdminAjax.php?do=salepage&act=delete',
		data: {'id':id},
		success:function (data) {
