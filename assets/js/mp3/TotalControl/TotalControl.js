...
soundManager.url = 'js/mp3/TotalControl/javascripts/soundmanager/swf';
...
(function( $ ) {
  $.fn.totalControl = function(options) {
     ...
     return this.each(function() {
		 ...
		 $('head').append('<link rel="stylesheet" href="js/mp3/TotalControl/css/' + options.style + '" type="text/css" />');
		 var playerHtml = '';
		 var totalSongs = 0;
		 var useFlash = "no";
